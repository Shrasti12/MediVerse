    ...
    <div className="upload-page">
      ...
      <main className="upload-container">
        <form className="form-section" onSubmit={handleSubmit}>
          <h1 className="headingU">Upload Prescription</h1>
          ...
          <fieldset>
            ...
            <div className="grid-2">
              ...
              <input type="text" name="hospital" value={formData.hospital} onChange={handleChange} placeholder="Hospital Name*" required />
              <input type="text" name="doctor" value={formData.doctor} onChange={handleChange} placeholder="Doctor's Name" />
          ...
          <fieldset>
            ...
            <div className="grid-2">
              <input type="text" name="receiptNo" value={formData.receiptNo} onChange={handleChange} placeholder="Receipt No" />
              <input type="date" name="date" value={formData.date} onChange={handleChange} required />
              <div className="upload-box">
                <label className="upload-label">
                  Upload Prescription <span className="required">*</span>
                </label>
                <small className="upload-note">(Only PDF files are accepted)</small>
              </div>
            </div>
          </fieldset>

          <div className="btn-group">
            <button type="submit" className="submit-btn-U">Submit</button>
            <button type="button" className="submit-btn-U" onClick={handleBack} disabled={submittedData.length === 0}>Back</button>
            <button type="button" className="submit-btn-U" onClick={handleClear}>Clear</button>
          </div>
        </form>
